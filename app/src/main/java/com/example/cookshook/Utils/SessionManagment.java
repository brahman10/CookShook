...
import static com.example.cookshook.Utils.Constants.IS_LOGIN;
import static com.example.cookshook.Utils.Constants.KEY_DESCRIPTION;
import static com.example.cookshook.Utils.Constants.KEY_DEVICE_ID;
import static com.example.cookshook.Utils.Constants.KEY_EMAIL;
import static com.example.cookshook.Utils.Constants.KEY_ID;
import static com.example.cookshook.Utils.Constants.KEY_LOCATION;
...
import static com.example.cookshook.Utils.Constants.KEY_REWARDS;
import static com.example.cookshook.Utils.Constants.KEY_STATUS;
import static com.example.cookshook.Utils.Constants.KEY_TITLE;
import static com.example.cookshook.Utils.Constants.KEY_WALLET;
import static com.example.cookshook.Utils.Constants.PREF_NAME;
...
public class SessionManagment {
    ...
    public void updateProfile(String name, String email, String img,String status)
    {
       editor.putString(KEY_NAME,name);
       editor.putString(KEY_EMAIL,email);
       editor.putString(KEY_PROFILE_IMG,img);
